          ...
          <div style="display: flex; justify-content: flex-end; margin-top: 20px;">
            <div class="summary-box" style="width: 280px;">
              <div class="summary-row">
                <span>Subtotal</span>
                <span>${model.currency}${formatMoney(model.subtotal)}</span>
              </div>
              ${model.gstEnabled ? `
                <div class="summary-row">
                  <span>Tax (GST)</span>
              ...
              ${model.totalDiscount > 0 ? `
                <div class="summary-row">
                  <span>Discount</span>
                  <span style="color: #10b981;">-${model.currency}${formatMoney(model.totalDiscount)}</span>
                </div>
              ` : ''}
              ${model.miscCharges > 0 ? `
                <div class="summary-row">
          ...
          <div class="footer-bottom">
            ...
            ${model.termsAndConditions ? `
              <div style="margin-bottom: 18px; padding: 12px 14px; background: #fafbfc; border-left: 3px solid #000; border-radius: 0 6px 6px 0;">
                ...
                <div style="font-size: 8.5px; line-height: 1.7; color: #4b5563; white-space: pre-wrap;">${escapeHtml(model.termsAndConditions)}</div>
              </div>
            ` : ''}
            ...
            <div class="footer-grid" style="display: flex; justify-content: center; width: 100%;">
              <div class="social-links" style="display: flex; gap: 15px; justify-content: center; width: 100%;">
                ${model.whatsappNumber ? `
                  <div class="social-badge" style="display: flex; align-items: center; gap: 8px; padding: 6px 12px; border-radius: 100px; border: 1px solid #e2e8f0; background: #fff;">
                    <div class="social-icon wa-icon" style="width: 20px; height: 20px; border-radius: 50%; background: #25D366; display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="social-label" style="font-size: 10px; font-weight: 700; color: #1e293b; line-height: 1.2;">
                      <small style="display: block; font-size: 7px; font-weight: 500; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.05em;">WhatsApp</small>
                      +${escapeHtml(model.whatsappNumber)}
                    </div>
                  </div>
                ` : ''}
                ${model.instagramId ? `
                  <div class="social-badge" style="display: flex; align-items: center; gap: 8px; padding: 6px 12px; border-radius: 100px; border: 1px solid #e2e8f0; background: #fff;">
                    <div class="social-icon ig-icon" style="width: 20px; height: 20px; border-radius: 50%; background: linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888); display: flex; align-items: center; justify-content: center;">
                      <svg viewBox="0 0 24 24" fill="white" style="width: 12px; height: 12px;"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
                    </div>
                    <div class="social-label" style="font-size: 10px; font-weight: 700; color: #1e293b; line-height: 1.2;">
                      <small style="display: block; font-size: 7px; font-weight: 500; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.05em;">Instagram</small>
                      @${escapeHtml(model.instagramId)}
                    </div>
                  </div>
                ` : ''}
              </div>
